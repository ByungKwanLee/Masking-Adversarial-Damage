import math
import torch
from models.vgg_mask import VGG
from models.resnet_mask import resnet
from models.wide_mask import wide_resnet

def get_mask_network(network, depth, dataset, device):
